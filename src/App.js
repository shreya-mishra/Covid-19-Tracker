...
function App() {
  ...
  const onCountryChange = async (event) => {
    ...
    //https://disease.sh/v3/covid-19/countries/saint%20martin
    const url =
    ...
    <div className="app">
      <div className="app__left">
        <div className="app__header">
          ...
          <FormControl className="app__dropdown">
            <Select
              ...
              value={country}
            >
              {/*Loop through all the countries ansd show a drop dpwn 
            list of the options (State)*/}
        ...
        <div className="app__stats">
          ...
          />
          {/*Infoboxes title="cocornavirus cases" */}
